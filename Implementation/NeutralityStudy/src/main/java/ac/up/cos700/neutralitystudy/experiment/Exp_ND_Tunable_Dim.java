 ...
 */
public class Exp_ND_Tunable_Dim extends Experiment {

    public Exp_ND_Tunable_Dim(StudyConfig _config, NeutralityMeasure _neutralityMeasure, RealProblem _problem) {
    ...
    protected void finalise() throws Exception {
        ...
        Results.newGraph(this, path, problem.getName() + " Neutrality vs Dimension", "Dimension", "Neutrality", "", 2);
