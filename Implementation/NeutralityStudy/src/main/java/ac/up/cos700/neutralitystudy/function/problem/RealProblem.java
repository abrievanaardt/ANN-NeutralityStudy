...
/**
 * This class represents a function, bounded in all dimensions by a
 * hypercube and with a known optimum value. This is intended to be treated 
 * as a landscape that can be searched by an optimisation algorithm. Where 
 * problems do not have known optima, this is indicated with Double.NaN and 
 * the corresponding vector will be null.
 * 
