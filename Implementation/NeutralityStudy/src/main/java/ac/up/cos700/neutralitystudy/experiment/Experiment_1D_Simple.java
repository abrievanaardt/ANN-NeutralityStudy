...
public class Experiment_1D_Simple extends Experiment {
    ...
    public Experiment_1D_Simple(StudyConfig _config, RealProblem _problem) {
        super(_config);
    ...
    protected void runSimulation(int currentSimulation) throws Exception {        
        ...
        NeutralityMeasure measure = new NeutralityMeasure1(epsilon);
        neutrality[currentSimulation - 1] = measure.measure(walks);
    }
    ...
    private final double epsilon = config.entries.get("epsilon");
