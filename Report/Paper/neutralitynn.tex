...
\and
\IEEEauthorblockN{Anna Rakitianskaia}
\IEEEauthorblockA{Department of Computer Science\\
University of Pretoria\\
Pretoria, South Africa\\
...
\subfloat[Flat]{\includegraphics[width=0.33\linewidth]{flat}%
\label{figFlat}}
\subfloat[Inverted Almost-flat]{\includegraphics[width=0.33\linewidth]{almostFlat}%
\label{figAlmostFlat}}
\subfloat[Inverted Table]{\includegraphics[width=0.33\linewidth]{table}%
\label{figTable}}

\subfloat[Easom]{\includegraphics[width=0.33\linewidth]{easom}%
\label{figEasom}}
\subfloat[Step 2]{\includegraphics[width=0.33\linewidth]{step2}%
\label{figStep2}}
\subfloat[Step 1]{\includegraphics[width=0.33\linewidth]{step1}%
\label{figStep1}}

\subfloat[Absolute Value]{\includegraphics[width=0.33\linewidth]{absoluteValue}%
