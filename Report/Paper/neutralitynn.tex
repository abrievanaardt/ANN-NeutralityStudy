...
\subsection{Results}
\label{nnResults}
Figure \ref{figNNNeutralityVsDomain} shows the neutrality measured for the various NNs problems using ${\mathcal{M}_1}$ and ${\mathcal{M}_2}$, respectively, for increasing domains centred around the origin of the MSE search space. Note the scale applied to the x-axis for readability. The first observation that can be made is the similarity in the behaviour of both measures across all problems: 
\begin{itemize}
...
Interestingly, iris and glass, even though follow the general trend of increasing saturation, exhibit lower levels of neutrality than the remaining problems. It has already been pointed out that iris and glass have more than one output neuron. Thus, the fitness of the resulting NN is the composite fitness of the numerous outputs. If the fitness of at least one of the few outputs changes, the overall fitness of the NN would change, too.
